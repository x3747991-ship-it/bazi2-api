...
# --- 【关键新增】Health Check Endpoint ---
# This route handles the health checks from the platform's gateway.
# It simply returns a 200 OK to prove the application is alive.
